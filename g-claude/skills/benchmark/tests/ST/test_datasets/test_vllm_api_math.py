...
class TestClass:
    ...
    # mode all
    def test_vllm_api_general_all_math_prm800k_500_0shot_cot_gen(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_math_prm800k_500_0shot_cot_gen"
    ...
    def test_vllm_api_general_all_math_prm800k_500_5shot_cot_gen(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_math_prm800k_500_5shot_cot_gen"
        datasets_abbr_name = "math_prm800k_500"

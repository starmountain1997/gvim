...
class TestClass:
    ...
    # mode all
    def test_vllm_api_general_all_aime2025_0_shot_str(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_aime2025_gen"
        datasets_abbr_name = "aime2025"
        datasets_script_name = "aime2025_gen"

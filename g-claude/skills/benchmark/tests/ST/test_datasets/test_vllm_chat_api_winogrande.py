...
class TestClass:
    ...
    def test_vllm_api_chat_all_winogrande_0_shot_chat_prompt(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_chat_winogrande_gen_0_shot_chat_prompt"
    ...
    def test_vllm_api_chat_all_winogrande_5_shot_chat_prompt(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_chat_winogrande_gen_5_shot_chat_prompt"
        datasets_abbr_name = "winogrande"

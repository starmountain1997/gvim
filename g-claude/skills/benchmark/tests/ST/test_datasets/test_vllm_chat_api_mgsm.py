...
class TestClass:
    ...
    def test_vllm_api_chat_all_mgsm_0_shot_cot_chat_prompt(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_chat_mgsm_gen_0_shot_cot_chat_prompt"
    ...
    def test_vllm_api_chat_all_mgsm_8_shot_cot_chat_prompt(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_chat_mgsm_gen_8_shot_cot_chat_prompt"
        datasets_abbr_name = "mgsm_"

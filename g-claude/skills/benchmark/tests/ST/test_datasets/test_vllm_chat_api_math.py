...
class TestClass:
    ...
    def test_vllm_api_chat_all_math500_gen_0_shot_cot_chat_prompt(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_chat_math500_gen_0_shot_cot_chat_prompt"
        datasets_abbr_name = "math_prm800k_500"
        datasets_script_name = "math500_gen_0_shot_cot_chat_prompt"
